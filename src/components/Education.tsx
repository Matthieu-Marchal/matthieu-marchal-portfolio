      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-4 text-primary">
            Formations, Certifications & Outils
          </h2>
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
            Un parcours de formation continue et une maîtrise des outils professionnels pour une performance commerciale optimale
          </p>
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* HubSpot CRM */}
              <div className="bg-card rounded-lg p-6 shadow-elegant hover:shadow-gold transition-all duration-300 text-center group">
            ...
            <div className="mt-8 bg-gradient-subtle rounded-lg p-6">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <span className="px-3 py-1 bg-background rounded-full text-sm border border-border">Salesforce</span>
                <span className="px-3 py-1 bg-background rounded-full text-sm border border-border">Microsoft Office</span>
                <span className="px-3 py-1 bg-background rounded-full text-sm border border-border">Slack</span>
                <span className="px-3 py-1 bg-background rounded-full text-sm border border-border">Trello</span>
                <span className="px-3 py-1 bg-background rounded-full text-sm border border-border">Shopify</span>
                <span className="px-3 py-1 bg-background rounded-full text-sm border border-border">WooCommerce</span>
              </div>
            </div>
          </div>
