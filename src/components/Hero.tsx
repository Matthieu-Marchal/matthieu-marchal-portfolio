  ...
  return (
    <section id="accueil" className="min-h-screen flex items-center bg-gradient-hero-main pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div 
          className="absolute top-40 right-20 w-1.5 h-1.5 bg-accent/30 rounded-full"
          animate={{
            y: [20, -20, 20],
            opacity: [0.3, 0.7, 0.3]
          }}
        ...
        />
        <motion.div 
          className="absolute bottom-40 left-1/3 w-1 h-1 bg-accent/50 rounded-full"
          animate={{
            x: [-10, 10, -10],
            opacity: [0.4, 0.9, 0.4]
          }}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimationWrapper type="scale" delay={0.5} className="flex justify-center lg:justify-end">
              ...
              >
                ...
                <motion.div 
                  className="absolute -bottom-4 -right-4 w-24 h-24 bg-gradient-accent rounded-full opacity-25 -z-10"
                  animate={{ 
                    scale: [1, 1.1, 1],
                    rotate: [0, 180, 360]
                  }}
                ...
                <motion.div 
                  className="absolute -top-2 -left-2 w-16 h-16 border-2 border-accent/30 rounded-full -z-10"
                  animate={{ 
                    rotate: [0, -360]
                  }}
                  transition={{ 
                ...
                <motion.div 
                  className="absolute top-10 -right-8 w-8 h-8 bg-primary/10 rounded-full -z-10"
                  animate={{ 
                    y: [-5, 5, -5],
                    opacity: [0.3, 0.7, 0.3]
                  }}
